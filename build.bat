@echo off
g++  -o main.exe src/main.cpp src/game.cpp src/renderer.cpp src/entity.cpp src/player.cpp src/tilemap.cpp src/tile.cpp src/map_editor.cpp src/combat_manager.cpp src/enemy.cpp ^
