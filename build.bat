@echo off
g++  -o main.exe src/main.cpp src/game.cpp src/renderer.cpp src/entity.cpp src/player.cpp src/tilemap.cpp src/tile.cpp src/map_editor.cpp src/combat_manager.cpp src/enemy.cpp src/ui_manager.cpp src/ui_label.cpp src/ui_button.cpp src/ui_panel.cpp src/ui_element.cpp ^
